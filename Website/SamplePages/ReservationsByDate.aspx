...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <table align="center" style="width: 70%">
        <tr>
            ...
            <td>
                <asp:TextBox ID="ReservationDateArg" runat="server" CausesValidation="true" ToolTip="Format mm/dd/yyyy" Text="01/01/1900"></asp:TextBox>
    ...
    <asp:ObjectDataSource ID="ODSReservationsByDate" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="GetReservationsByDate" TypeName="eRestuarantSystem.BLL.AdminController">
        <SelectParameters>
